  ...
  return (
    <>
      ...
      >
        ...
        {/* Low stock banner — shown when ≤30ml remaining */}
        {!sold_out && ml_remaining != null && ml_remaining <= 30 && (
          <div
            style={{
              position: 'absolute',
              bottom: 0,
          ...
          >
            ...
            >
              {ml_remaining <= 10
                ? `⚠ Only ${ml_remaining}ml left — almost gone`
                : `🟡 ${ml_remaining}ml remaining — selling fast`}
            </span>
          </div>
        )}
        <button
